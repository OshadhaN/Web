...
function addProducttoFav(title, price, productImg){
    ...
    var favBoxContent = `
                            ...
                            <img src="./Images/delete.png" alt="delete icon" class="fav-remove">`;
...
function addProducttoCart(title, price, productImg){
    ...
    var cartBoxContent = `
                            ...
                            <img src="./Images/delete.png" alt="delete icon" class="cart-remove">`;
...
function checkLoyalty(){
    if (Cart.length > 3){
        ...
        alert('You have no loyalty points earned' ) 
    }
}
